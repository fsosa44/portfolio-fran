...
function App() {
  ...
  return (
    <>
      {/* TopNavBar */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#060e20]/80 backdrop-blur-md shadow-[0_20px_40px_rgba(0,0,0,0.4)] h-20">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-8 h-full">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              className="text-primary font-semibold border-b-2 border-primary pb-1 font-headline tracking-tight hover:opacity-80 transition-all duration-300"
              href="#work"
            >
              {t.nav.projects}
            </a>
            <a
              className="text-on-surface-variant font-medium font-headline tracking-tight hover:text-primary hover:opacity-80 transition-all duration-300"
              href="#about"
            >
              {t.nav.about}
            </a>
      ...
      <main>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center pt-32 px-8 text-center bg-surface">
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-16 md:mb-0">
            ...
            <a
              className="border border-outline-variant/30 text-on-surface px-10 py-4 rounded-xl font-bold text-lg hover:bg-surface-container-low transition-colors active:scale-95"
              href="#contact"
            >
              {t.hero.contactMe}
            </a>
        ...
        <section className="py-32 px-8 bg-surface" id="work">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group bg-surface-container-high rounded-xl overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:bg-surface-container-highest flex flex-col">
